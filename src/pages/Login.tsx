'use client';
// import { ENDPOINTS } from '@/utils/constants/network/endpoints';
// import { baseUrl } from '@/utils/constants/network/url';
...
//     const { resData, status, CODES }: any = await requestAPI(
//       'GET',
//       ENDPOINTS.CHECK_AUTH,
//       {},
//     );
...
//   }, []);
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-indigo-50 via-white to-blue-50 flex items-center justify-center p-4 sm:p-6 md:p-10">
      <div className="w-full max-w-6xl bg-white rounded-3xl shadow-2xl overflow-hidden flex flex-col md:flex-row">
        <div className="w-full md:w-1/2 p-6 sm:p-10 md:p-16 flex flex-col justify-center">
          ...
          >
            ...
            >
              <Input
                className="h-12 rounded-xl text-base border-gray-200 hover:border-blue-300 focus:border-blue-300 shadow-sm"
            ...
            <div className="text-center">
                <p className="text-sm text-gray-500">Don't have an account? 
                    <span className='text-indigo-700 pl-1'><Link to="/register">Create here</Link></span>
                </p>
            </div>
            ...
            <Button
              ...
              className="h-14 w-full rounded-xl border border-gray-200 hover:border-gray-300 hover:bg-gray-50 shadow-sm flex items-center justify-center gap-2 text-base font-medium transition-all duration-300"
            >
